...
if x_axis and y_axis:
    ...
    malignant_df.plot.scatter(x=x_axis, y=y_axis, s=50, c="red", alpha=0.6, ax=scatter_ax, label="Malignant")
    benign_df.plot.scatter(x=x_axis, y=y_axis, s=50, c="blue", alpha=0.6, ax=scatter_ax,
